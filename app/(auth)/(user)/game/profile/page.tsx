...
const WishlistSection = () => {
  ...
  const [user, setUser] = useState<{
    ...
    subscriptionTypeEnd: string | null | undefined;
  } | null>(null);
  ...
  }, [user]); // Dependencies: only re-create function when user changes
        ...
        <div className="space-y-4">
          {cartItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="flex items-center gap-4 border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
              >
