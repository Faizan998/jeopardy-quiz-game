...
import { Product } from '@/app/type/types'; // Adjust import path as needed
  ...
  return (
    <div className="container mx-auto px-4 bg-gradient-to-r from-blue-900 to-blue-600 dark:bg-blue-500 text-white transition-all duration-300 ease-in-out py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href="/admin-dashboard/create-Product" // Adjust this path as needed
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product) => (
            ...
            >
              ...
              {/* Title Section */}
              <h2 className="text-md font-semibold text-gray-700 mb-2">{product.title}</h2>
